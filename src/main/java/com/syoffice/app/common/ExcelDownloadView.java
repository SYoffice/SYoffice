...
public class ExcelDownloadView extends AbstractView {
	...
	// === #194. Excel 파일로 다운로드 해주는 메소드 재정의(Override) 하기 === //
	@Override
	protected void renderMergedOutputModel(Map<String, Object> model, 
                                 		   HttpServletRequest request,
                                 		   HttpServletResponse response) throws Exception {
		
		Locale locale = (Locale) model.get("locale");	// 넘겨받은 Model(다운로드 될 엑셀파일의 정보)
		// Locale 클래스는 지역의 [언어][나라] 등의 정보를 담고 있는 클래스이다. 
		
		String workbookName = (String) model.get("workbookName");	// 넘겨받은 Model(다운로드 될 엑셀파일의 정보) - 엑셀파일명
        ...
        String fileName = workbookName = workbookName +"_"+ day +"_"+ hour+".xlsx";	// HR사원정보_20250214_113225.xlsx
	...
	}// end of protected void renderMergedOutputModel() ----------------------- 
}
