...
public class ApprovalController {
	...
	public ModelAndView writeDraftForm(HttpServletRequest request, ModelAndView mav,
			ApprovalVO approval,
	...
	public ModelAndView writeLeaveForm(HttpServletRequest request, ModelAndView mav,
									ApprovalVO approval,
									@RequestParam(defaultValue = "") String leave_type, 
									@RequestParam(defaultValue = "") String leave_startdate, 
	...
	public int acceptApr(HttpServletRequest request, String apr_no) {
		...
		int n = apvservice.acceptApr(apr_no, loginuser.getEmp_id());
