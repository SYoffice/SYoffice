    ...
    <div class="contents_wrapper">
        <div class="contents_inner_wrapper">
        	...
        	<div class="toolbar_area">
        		...
        		<button type="button" onclick="tempStore('${sessionScope.loginuser.emp_id}')">임시저장</button>
        	</div>
	        		...
	        		<table id="schedule" class="table">
						...
						<tr>
							<th class="title_area">
								...
								<input class="title_checkbox" type="checkbox" id="important" name="mail_important">
