    ...
    $.ajax({
        ...
        success: function(chatrooms) {
            ...
            if (chatrooms.length === 0) {
                ...
                `);
                sidebarChatList.append("<li class='text-center'>참여 중인 채팅방이 없습니다.</li>");
            } else {
                chatrooms.forEach(room => {
                    let participantCount = room.employees.length;
                    ...
                    let chatRow = `
                        <tr>
                            ...
                            <td class="text-center">\${participantCount}명</td>
                            <td class="text-right">
...
function enterChatroom(roomId) {
    console.log("입장하는 채팅방 Id:", roomId); 
