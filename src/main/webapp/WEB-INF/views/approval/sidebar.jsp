...
uri="http://java.sun.com/jsp/jstl/core"%> <% String ctxPath =
request.getContextPath(); // /syoffice %>
...
<div class="common_wrapper">
  <div class="side_menu_wrapper">
    <div class="side_menu_inner_wrapper">
      ...
      <button
        type="button"
        data-toggle="modal"
        data-target="#selectAprFormModal"
      >
        기안문서 작성
      </button>
      <ul class="side_menu_list" id="side_menu">
        ...
        <li>
          <a href="<%=ctxPath%>/approval/obtain_approval_box">결재대기문서함</a>
        </li>
  ...
  <div class="contents_wrapper">
    <div class="contents_inner_wrapper"></div>
  </div>
</div>
